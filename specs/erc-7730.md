...
Sometimes, embedded calldata may require a transaction value to be correctly clear signed, as the underlying function might spend a value passed from its parent transaction.
...
In such cases, the `amount` parameter can be used to specify this value:
...
| `calleePath` or `callee` | A path reference or constant value for the contract being called. If not present, the contract being called is interpreted as the same as the caller                                                                                                                                                                                                                                                                         |
