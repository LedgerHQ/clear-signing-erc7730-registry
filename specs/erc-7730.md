...
`fields` is an array of elements, each element being either:
  ...
  * A recursive [*structured data format specification*](#structured-data-format-specification), by including another list of fields under a `fields` sub-key. 
            ...
            "myFunction(address _address,uint256 _amount,MyParamType _param)" : {
                "fields": [
                    ...
                    },
                    {
                        "path": "_param",
                        "fields": [
                            { "path": "name", "$ref": "S.display.definitions.itemName" },
                            { "path": "value", "$ref": "S.display.definitions.itemReference" }
                        ]
                    }
                ]
            }
...
```json
{
    "display": {
        "formats": {
            "myFunction(address _address,uint256 _amount,MyParamType _param)" : {
                "fields": [
                    { "path":"_param.name", "$ref": "S.display.definitions.itemName" },
                    { "path":"_param.value", "$ref": "S.display.definitions.itemReference" }
                ]
            }
        }
    }
