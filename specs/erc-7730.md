...
* The `path` is the absolute or relative path to the field location in the structured data, as described in the [path section](#path-references). Alternatively, a constant can be used instead of looking up a field in the structured data by using the `value` key instead of `path`.
...
| *Parameters*           | ---                                                                                                                                                                                                                               |
| `token` or `tokenPath` | address or path reference to the address of the token contract. Used to associate correct ticker. If ticker is not found or tokenPath is not set, the wallet SHOULD display the raw value instead with an "Unknown token" warning |
...
| *Parameters*                            | ---                                                                                                           |
| `collection` or `collectionPath`        | The collection address or a path reference to the collection address                                          |
| *Examples*                              | ---                                                                                                           |
...
| `callee` or `calleePath` | Address or path reference to the contract being called                                                                                                                                                                                                                                                                                                                    |
| *Examples*               |                                                                                                                                                                                                                                                                                                                                                                           |
